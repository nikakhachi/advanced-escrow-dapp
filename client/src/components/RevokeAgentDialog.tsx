...
interface RevokeAgentDialogProps {
  open: boolean;
  handleClose: () => void;
}

export const RevokeAgentDialog: FC<RevokeAgentDialogProps> = ({ handleClose, open }) => {
  ...
  const handleConfirm = async () => {
    setIsLoading(true);
    await escrowAgentContext?.revokeAgent(address);
    setAddress("");
    setIsLoading(false);
  };
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle>Revoke an agent</DialogTitle>
      <DialogContent>
